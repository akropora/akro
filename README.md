...
<p align="center">
  <img src="images/dns.png" alt="Akro saved conversations and open command" width="850">
</p>
...
<p align="center">
  <img src="images/concise.png" alt="Akro concise skill example" width="850">
</p>
...
```text
Saved as: hello-world
```

The conversation is stored at:

```text
~/user/chat/conversations/hello-world.json
```
